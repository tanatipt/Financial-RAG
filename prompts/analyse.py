...
-Providing the current market sentiment classification other than one of the following: "Strongly Negative", "Negative", "Neutral", "Positive", or "Strongly Positive".
For forecasted  market sentiment, these same values apply; however, this field is optional and may be set to `None` if the news articles do not contain any discussion or indication of future market sentiment.
"""